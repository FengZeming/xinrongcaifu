    ...
    <div class="about_list">
      ...
      <dl>
        ...
        <dd class="paddingl">
          <ul class="img_list">
            <li>
              <p><img src="../../images/about/04.jpg"  /></p>
              <p>坚持合法合规路线  坚守职业道德  通过创造有益价值获取回报</p>
            </li>
            <li>
              <p><img src="../../images/about/05.jpg"  /></p>
              <p>待人真诚   信守承诺   勇于承担责任</p>
            </li>
            <li>
              <p><img src="../../images/about/06.jpg"  /></p>
              <p>敏于发现机遇   善于创造性解决问题   敢于打破常规</p>
            </li>
            <li>
              <p><img src="../../images/about/07.jpg"  /></p>
...
<li><h2><a href="help.shtml.htm"  target="_blank">帮助中心</a></h2><p><a href="guide/guide1.shtml.htm"  target="_blank">新手指引</a></p><!--<p><a href="help.shtml-tab=tab1.htm"  target="_blank">问题答疑</a></p>--><p><a href="help.shtml-tab=tab10.htm"  target="_blank">投资攻略</a></p><p><a href="javascript:if(confirm('http://bbs.xin.com/forum-49-1.html  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.xin.com/forum-49-1.html'"  target="_blank">意见反馈</a></p></li>
    ...
    <fieldset class="ui-form">
        <form id="rapid-login-form" method="post" action="https://xin/v2/login/login.jso">
            ...
            <div class="ui-form-line ui-form-action">
                ...
                <em class="ui-tip"></em>
                <img src="../../images/Connect_logo_7.png"  AA.RapidLogin.qqClick();" style="cursor:pointer; margin-left:8px;"></img>
            </div>
            <style>
