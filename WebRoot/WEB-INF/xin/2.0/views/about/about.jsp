      ...
      <ul>
        ...
        <li><a href="invest_help.shtml.htm" tppabs="https://xin/2.0/views/about/invest_help.shtml" id="nav_invest_help">新手指引<i class="arrow"></i></a>
          <ul>
            ...
            <!--<li><a href="help.shtml.htm" tppabs="https://xin/2.0/views/about/help.shtml" id="nav_help" target="_blank">问题答疑</a></li>-->
          </ul>
        </li>
        <li><a href="about.shtml.htm" tppabs="https://xin/2.0/views/about/about.shtml" id="nav_about">信息披露<i class="arrow"></i></a>
          <ul>
            ...
            <!--<li><a href="xr_announcement.shtml.htm" tppabs="https://xin/2.0/views/about/xr_announcement.shtml">平台公告</a></li>-->
            <li><a href="partner.shtml.htm" tppabs="https://xin/2.0/views/about/partner.shtml">合作机构</a></li>
            <!--<li><a href="contact.shtml.htm" tppabs="https://xin/2.0/views/about/contact.shtml">联系我们</a></li>-->
          </ul>
        </li>
      </ul>
...
<div class="sidebar_a left">
      ...
      <ul>
        <li class="h_cur"><h2 id="fabout">公司简介<i class="h_img">></i></h2>
          <ul class="f_show">
            ...
            <!--<li id="side_nav_xrmien"><a href="xr_mien.shtml.htm" tppabs="https://xin/2.0/views/about/xr_mien.shtml">公司风采</a></li>-->
        ...
        <!--<li id="side_nav_xrreport"><a href="xr_report.shtml.htm" tppabs="https://xin/2.0/views/about/xr_report.shtml">信融年报</a></li>-->
  ...
  <div class="sidebar_b right">
    ...
    <h1 class="sidetitle"><span>信融简介</span></h1>
    <div class="about_font">
      <p>　　深圳市信融财富投资管理有限公司创办于2012年3月，注册资本6904.55万元人民币，实收资本5704.55万元人民币，总部位于深圳，拥有完整的产品、研发、风控、财务以及客服等职能体系，是一家具备优秀的自主研发能力的金融创新型企业，在2014年当选广东互联网金融协会首届副会长单位。我们旨在通过为投资人提供低风险、收益率适中的投资理财服务，帮助其实现资产的稳健增值；同时，通过为融资方高效解决资金需求，帮助其改善生产和生活。</p>
      <p>　　作为P2P行业的”元老级”人物，信融财富坚持以创造投资人价值为核心，以信致远，赢得了良好的用户口碑。</p>
    </div>
    <div class="about_list">
      <dl>
        <dt>
          <h2><i class="dot"></i>使命</h2>
        </dt>
        <dd>通过为投资人提供<span class="orange">低风险、收益率适中</span>的投资理财服务，帮助其实现资产的<span class="orange">稳健增值</span>；<br />
          通过为融资方高效解决资金需求，帮助其改善生产和生活。</dd>
      </dl>
      <dl>
        <dt>
          <h2><i class="dot"></i>愿景</h2>
        </dt>
        <dd><span class="orange">成为受信赖的投资融资服务平台</span></dd>
      </dl>
      <dl>
        <dt>
          <h2><i class="dot"></i>价值观</h2>
        </dt>
        <dd class="paddingl">
          <ul class="img_list">
            <li>
              <p><img src="../../images/about/04.jpg" tppabs="https://xin/2.0/images/about/04.jpg" /></p>
              <p>坚持合法合规路线  坚守职业道德  通过创造有益价值获取回报</p>
            </li>
            <li>
              <p><img src="../../images/about/05.jpg" tppabs="https://xin/2.0/images/about/05.jpg" /></p>
              <p>待人真诚   信守承诺   勇于承担责任</p>
            </li>
            <li>
              <p><img src="../../images/about/06.jpg" tppabs="https://xin/2.0/images/about/06.jpg" /></p>
              <p>敏于发现机遇   善于创造性解决问题   敢于打破常规</p>
            </li>
            <li>
              <p><img src="../../images/about/07.jpg" tppabs="https://xin/2.0/images/about/07.jpg" /></p>
              <p>追求完美   为远大目标不懈努力   乐于迎接挑战迎难而上</p>
            </li>
          </ul>
          <div class="clear"></div>
        </dd>
      ...
      <dl>
        <dt>
          <h2><i class="dot"></i>经营理念</h2>
        </dt>
        <dd>以<span class="orange">创造投资人价值</span>为核心，兼顾融资效率和平台收益，打造<span class="orange">健康、可持续发展</span>平台</dd>
      </dl>
      <dl>
        <dt>
          <h2><i class="dot"></i>公司氛围</h2>
        </dt>
        <dd><span class="orange">融洽、宽松、开放、平衡 　 　重视用户体验</span> 　 　<span class="orange">积极学习、乐于分享</span></dd>
      </dl>
    </div>
  </div>
  <!--right end-->
...
$(document).ready(function() {
	...
	$("#side_nav_index").each(function(){
     $("#side_nav_index").addClass("cur");
