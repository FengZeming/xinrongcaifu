  ...
  <div class="sidebar_b right">
    ...
    <div class="about_list partner_list">
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            ...
            <li><img src="../../images/about/partner/jiangxi.jpg"  height="34" /></li>
            <li><img src="../../images/about/partner/jianshe.png" height="34" /></li>
            <li><img src="../../images/about/partner/tenpay.jpg"  height="34" /></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            <li><a href="partner/huazhen.html" ><img src="../../images/about/partner/huazhen.jpg"  height="40" /></a></li><li><a href="partner/chinlink.html" ><img src="../../images/about/partner/chinlink.jpg"  height="40" /></a></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            <li><a href="javascript:if(confirm('http://www.lianjianlawyer.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.lianjianlawyer.com/'"  target="_blank"><img src="../../images/about/partner/lianjian.jpg"  height="56" /></a></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl style="display:none;">
        ...
        <dd>
          <ul class="partnerimg">
            <li><a href="partner/hengsheng.html" ><img src="../../images/about/partner/hengsheng.jpg"  height="68" /></a></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            <li><a href="javascript:if(confirm('https://www.xin.xin/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.xin.xin/#/home'"  target="_blank"><img src="../../images/about/partner/zhima.jpg"  height="92" /></a></li>
            <li><p class="black15"></p><a href="javascript:if(confirm('https://www.tongdun.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.tongdun.cn/'"  target="_blank"><img src="../../images/about/partner/tongdun.png"  height="45" /></a></li>
            <li><p class="black15"></p><a href="javascript:if(confirm('https://www.ebaoquan.org/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.ebaoquan.org/'"  target="_blank"><img src="../../images/about/partner/ebaoquan.png"  height="45" /></a></li>
            <li><p class="black15"></p><a href="javascript:if(confirm('https://www.tsign.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.tsign.cn/'" ><img src="../../images/about/partner/lsign.png"  height="45" /></a></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            ...
            <li><a href="partner/jiwu.html" ><img src="../../images/about/partner/jiwu.jpg"  height="40" /></a></li>
            <li><a href="partner/rong360.html" ><img src="../../images/about/partner/rong360.jpg"  height="40" /></a></li>
            <li><a href="partner/fenqix.html" ><img src="../../images/about/partner/fenqix.jpg"  height="40" /></a></li>
            <li class="paddingr"><a href="partner/mingte.html" ><img src="../../images/about/partner/mingte.jpg"  height="40" title="明特商业保理有限公司" /></a></li>
      ...
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            <li><img src="../../images/about/partner/huawei.jpg"  height="50" /></li>
            <li><img src="../../images/about/partner/dianxin.png"  height="50" /></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            <li><a href="partner/zhaoshang.html" ><img src="../../images/about/partner/zhaoshang.png"  /></a></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul class="partnerimg">
            <li><a href="javascript:if(confirm('http://www.wdzj.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.wdzj.com/'"  target="_blank"><img src="../../images/about/partner/Partners.jpg"  height="40" /></a></li>
            <li><a href="javascript:if(confirm('http://www.touzhijia.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.touzhijia.cn/'"  target="_blank"><img src="../../images/about/partner/touzhijia.png"  height="40" /></a></li>
            <li><a href="javascript:if(confirm('http://www.fengchelicai.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.fengchelicai.com/'"  target="_blank"><img src="../../images/about/partner/fengchelicai.jpg"  height="40" /></a></li>
          </ul>
          <div class="clear"></div>
        </dd>
      </dl>
