...
<div class="sidebar_a left">
  ...
  <div class="sidebar_b right">
    ...
    <h1 class="sidetitle"><span>股东信息</span></h1>
    <div class="shareholder_font">
    <h2 style="display:none">深圳市信融财富投资管理有限公司股东信息</h2>
    <div><img src="../../images/about/gud.jpg" tppabs="https://xin/2.0/images/about/gud.jpg" /></div>
    <div class="shareholder_table" style="display:none">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <thead>
  <tr>
    <th width="295">股东名称</th>
    <th>出资比例</th>
    <th>股东类别</th>
  </tr>
  </thead>
...
$(document).ready(function() {
	...
	$("#side_nav_shareholder").each(function(){
     $("#side_nav_shareholder").addClass("cur");
