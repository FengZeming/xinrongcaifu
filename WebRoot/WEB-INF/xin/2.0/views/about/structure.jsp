...
<div class="sidebar_a left">
  ...
  <div class="sidebar_b right">
    ...
    <h1 class="sidetitle"><span>公司架构</span></h1>
    <div class="shareholder_font">
    <h2 style="display:none">深圳市信融财富投资管理有限公司股东信息</h2>
    <div><img src="../../images/about/27.jpg" tppabs="https://xin/2.0/images/about/27.jpg" /></div>
    </div>
...
<li><h2><a href="about.shtml.htm" tppabs="https://xin/2.0/views/about/about.shtml" target="_blank">信息中心</a></h2><!--<p><a href="xr_announcement.shtml.htm" tppabs="https://xin/2.0/views/about/xr_announcement.shtml" target="_blank">平台公告</a></p>--><p><a href="activitysum.shtml.htm" tppabs="https://xin/2.0/views/about/activitysum.shtml" target="_blank">信融点滴</a></p><p><a href="javascript:if(confirm('http://bbs.xinrong.com/forum.php  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.xinrong.com/forum.php'" tppabs="http://bbs.xinrong.com/forum.php" target="_blank">社 区</a></p></li>
...
$(document).ready(function() {
	...
	$("#side_nav_structure").each(function(){
     $("#side_nav_structure").addClass("cur");
