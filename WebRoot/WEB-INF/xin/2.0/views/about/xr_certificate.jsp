...
<div class="sidebar_a left">
  ...
  <div class="sidebar_b right">
    ...
    <ul>
      <li><a class="example-image-link" href="../../images/about/credit/17.jpg"  data-lightbox="example-59"><img class="example-image" src="../../images/about/credit/17.jpg"  height="194" title="企业法人营业执照" /></a></li>
      <li style="display:none"><a class="example-image-link" href="../../images/about/credit/08.jpg"  data-lightbox="example-60"><img class="example-image" src="../../images/about/credit/08.jpg"  height="174" title="中华人民共和国组织机构代码证" /></a></li>
      <li style="display:none"><a class="example-image-link" href="../../images/about/credit/09.jpg"  data-lightbox="example-61"><img class="example-image" src="../../images/about/credit/09.jpg"  height="174" title="税务登记证" /></a></li>
     <li><a class="example-image-link" href="../../images/about/credit/x02.png" data-lightbox="example-59"><img class="example-image" src="../../images/about/credit/x02.png"  height="194" title="信息系统安全等级保护备案证明" /></a></li>
     <li><a class="example-image-link" href="../../images/about/credit/x03.jpg"  data-lightbox="example-59"><img class="example-image" src="../../images/about/credit/x03.jpg"  height="194" title="深圳市信息安全等级保护测评结果通知书" /></a></li>
      </ul>
    <div class="clear"></div>
    </div>
...
<li><h2><a href="about.shtml.htm"  target="_blank">信息中心</a></h2><!--<p><a href="media_report.shtml.htm"  target="_blank">媒体报道</a></p>--><p><a href="activitysum.shtml.htm"  target="_blank">信融点滴</a></p><p><a href="javascript:if(confirm('http://bbs.xin.com/forum.php  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.xin.com/forum.php'"  target="_blank">社 区</a></p></li>
