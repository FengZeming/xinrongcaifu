...
<div class="AccountRight right">
	<div class="AccountBoxbr">
  		<h1><span class="left BoxbrTitle"><span id="leftTitle">上午好，--</span><a href="#" id="isCheckedEmail"><i class="wmail AllIcon" title="邮箱"></i></a><a href="#" id="isCheckedMobile"><i class="wtel AllIcon" title="手机"></i></a><a href="#" id="isCheckedIdentification"><i class="wID AllIcon" title="身份证"></i></a><a href="#" id="isCheckedBankCard"><i class="wbank AllIcon" title="银行卡"></i></a></span>
  			<span class="right BoxBrTitlefont" id="unVip"><i class="AllIcon Icon01"></i><a href="../../vip.html" tppabs="https://xin/2.0/vip.html">成为VIP会员，尊享多项特权！ </a></span>
  			<span class="right BoxBrTitlefont01" id="vip" style="display:none;"><p class="red"><i class="AllIcon icon01"></i>您是尊贵的<span id="vipGrade">-</span>会员！</p>有效期至：<span id="vipDeadLine">--</span> <a href="../../vip.html" tppabs="https://xin/2.0/vip.html" class="blue">详情</a></span>
  		</h1>
  		<div class="clear"></div>
  		<div class="AccountIndexfont">
  			<div class="indextop">
				<dl>
					...
					<dd class="font01"><span class="AFont"><b class="red" id="money">--</b>元 </span><span class="font02"><a class="blue" href="../../../invest.shtml.htm" tppabs="https://xin/invest.shtml">投资</a> | <a class="blue" href="../../../my/recharge.htm" tppabs="https://xin/my/recharge">充值</a> | <a class="blue" href="../../../my/deposit.htm" tppabs="https://xin/my/deposit">提现</a> | <a class="blue" href="../../xincunbao.shtml.htm" tppabs="https://xin/2.0/xincunbao.shtml">信存宝</a></span></dd>
					<div class="clear"></div>
				</dl>
  				<dl>
					<dt>投资礼金：</dt>
					<dd><span id="rewardMoney">--</span>元<span id="deadline"></span> <a href="../about/help.shtml-tab=tab3&href=c18.htm#nc18" tppabs="https://xin/2.0/views/about/help.shtml?tab=tab3&href=c18#nc18" class="blue" target="_blank" style=" margin-left:8px;">使用须知</a> <a href="../../../action/reg_invite.htm" tppabs="https://xin/action/reg_invite" target="_blank" class="blue" style=" margin-left:8px;">推荐赢礼金</a></dd>
				</dl>
				<div class="black10"></div>
				<dl>
					<dt>积分值：</dt>
					<dd><span id="score" class="red">--</span> 分 <a href="javascript:if(confirm('http://bbs.xinrong.com/thread-3866-1-1.html  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.xinrong.com/thread-3866-1-1.html'" tppabs="http://bbs.xinrong.com/thread-3866-1-1.html" target="_blank" class="blue">赚取积分</a> <a href="../../../action/jf.htm" tppabs="https://xin/action/jf" class="blue" style=" margin-left:8px;">立即抽奖&gt;&gt;</a></dd>
				</dl>
				<div class="black10"></div>
			</div>
			...
			<div class="xincuenbao">
						...
						<ul>
							<li>
								...
								<div class="tooltip cuenrumain">
									<div class="tippic"><img src="../../images/acc.jpg" tppabs="https://xin/2.0/images/acc.jpg" width="20" height="12" /></div>
		  							<div id="tool01_close" class="tipclose"><img src="../../images/close.png" tppabs="https://xin/2.0/images/close.png" width="11" height="11" /></div>
									<div class="tipcuenru">
										<dl class="w01">
											<dt>金额：</dt>
										...
										<dl class="w02">
											<dt>交易密码：</dt>
											<dd><input type="password" placeholder="" class="text01" id="crPass" /> <a href="back_password.shtml-tab=2.htm" tppabs="https://xin/2.0/views/account/back_password.shtml?tab=2">忘记密码？</a><p class="red" id="crPassError">报错</p></dd>
										</dl>
										<div class="clear"></div>
										<span class="fontxy"><input id="readme" type="checkbox" checked="checked" /> 我已阅读并接收<a href="../../../about/xcb_xieyi.htm" tppabs="https://xin/about/xcb_xieyi" class="blue">《信存宝服务用户协议》</a></span>
										<span class="fontxy" style="display:none;"><i class="icon01 AllIcon"></i>份额已满，敬请期待下一轮发布</span>
									</div>
									<div class="tipcuenrusub"><a href="#" class="sub02" id="crSub">提交</a><p id="crjuhua" style="display: none;"><img src="../../images/load.gif" tppabs="https://xin/2.0/images/load.gif" width="28" height="28" /></p><p id="crFailP" style="display:none;"><i class="Icon01 AllIcon"></i><span id="crFail" style="color:red">存入失败</span></p>
									</div>
									<div class="clear"></div>
								</div>
							</li>
							<li>
								...
								<div class="tooltip zhuanchumain">
	  								<div class="tippic"><img src="../../images/acc.jpg" tppabs="https://xin/2.0/images/acc.jpg" width="20" height="12" /></div>
	  								<div id="tool02_close" class="tipclose"><img src="../../images/close.png" tppabs="https://xin/2.0/images/close.png" width="11" height="11" /></div>
									<div class="tipcuenru">
										<dl class="w01">
											<dt>金额：</dt>
										...
										<dl class="w02">
											<dt>交易密码：</dt>
											<dd><input id="zcPass" type="password" placeholder="" class="text01" /> <a href="back_password.shtml-tab=2.htm" tppabs="https://xin/2.0/views/account/back_password.shtml?tab=2">忘记密码？</a><p class="red" id="zcPassError"></p></dd>
										</dl>
	  									<div class="clear"></div>
	  									<span class="fontxy"><input id="readme2" type="checkbox" checked="checked" /> 我已阅读并接收<a href="../../../about/xcb_xieyi.htm" tppabs="https://xin/about/xcb_xieyi" class="blue">《信存宝服务用户协议》</a></span>
	  									<span class="fontxy" style="display:none;"><i class="icon01 AllIcon"></i>份额已满，敬请期待下一轮发布</span>
									</div>
									<div class="tipcuenrusub"><a id="zcSub" href="#" class="sub02">提交</a><p id="zcjuhua" style="display:none;"><img src="../../images/load.gif" tppabs="https://xin/2.0/images/load.gif" width="28" height="28" /></p><p id="zcFailP" style="display: none;"><i class="Icon01 AllIcon"></i><span id="zcFail" style="color:red">存入失败</span></p>
									</div>
									<div class="clear"></div>
	  							</div>
	  						</li>
	  						<li>
	  							<div id="tool05"><a href="../../xincunbao.shtml.htm" tppabs="https://xin/2.0/xincunbao.shtml" class="blue">了解更多</a></div>
	  						</li>
						</ul>
					</span>
				</div>
  			...
  			<div class="black10"></div>
  			<h2><span class="left">账户资产概览</span><a href="../../../my/invest.htm" tppabs="https://xin/my/invest" class="blue right">详情</a></h2>
  			<div class="clear"></div>
  			<div class="black10"></div>
			<div class="Accountgl">
				<dl>
	...
	<div class="IntegralBox borrowingtab">
  	...
  	<div class="t-foot">查询不到？可能项目已全部/结束回款，请进“<a href="../../../my/consume.htm" tppabs="https://xin/my/consume" class="blue">收支查询</a>”，它也可以为您指定日期查询</div>
</div>
<!--right end-->
<div class="black25"></div>
</div>
...
<div id="authorize_box" style="display:none;">
	<div class="borrowingdialog" style="width:450px; height:240px;">
		...
		<div class="black25"></div>
		<div class="black10"></div>
		<div class="repaymentsub"><a id="authorize_box_ok" href="back_password.shtml-tab=2.htm" tppabs="https://xin/2.0/views/account/back_password.shtml?tab=2" class="accsub01">立即设置</a> <a id="authorize_box_cancel" href="javascript:void(0)" class="accsub02">以后再说</a></div>
	</div>
</div>
<!--交易密码设置-->
...
<script type="text/javascript" src="../../js/www/account/account_index.js" tppabs="https://xin/2.0/js/www/account/account_index.js"></script>
<script type="text/javascript" src="../../js/www/bank_cards.js" tppabs="https://xin/2.0/js/www/bank_cards.js"></script>
<script type="text/javascript" src="../../js/www/account/refund_plan.js" tppabs="https://xin/2.0/js/www/account/refund_plan.js"></script>
<script type="text/javascript">
$(document).ready(function() {
