	...
	<div class="contents marginbot">
		<div id="content1" class="tabscontent">
			<div id="find_pwd_1" class="password_list">
				...
				<dl>
					<dt>设置新密码：</dt>
					<dd><input id="pwd" type="password" class="inputtext" /><span id="password_toggle_btn" class="f-eyes"><img src="../../images/eye_close.png" tppabs="https://xin/2.0/images/eye_close.png" width="36" height="36" /></span>
				...
				<dl>
					<dt>&nbsp;</dt>
					<dd><a id="rest_pwd" href="javascript:void(0)" class="sub02">确 定</a> <span id="rsloginpwd_loading" class="gray" style="display:none;"><img src="../../images/loading.gif" tppabs="https://xin/2.0/images/loading.gif" width="16" height="16" /> 正在提交中...</span></dd>
					<div class="clear"></div>
				</dl>
			</div>
			<div id="find_pwd_2" class="password_list" style="display:none">
				<dl>
					...
					<dd class="font12" id="success_tip2" style="display:none">您的登录密码和交易密码均已重置成功。交易密码用于投资、提现等交易环节，已设为与登录</br>密码一致，请及时修改.<a style="color:blue"href="account_settings.shtml-tab=2.htm" tppabs="https://xin/2.0/views/account/account_settings.shtml?tab=2">立即修改></a><br />
					</dd><br />
					<div class="clear"></div>
				</dl>
				...
				<dl class="wordsub">
					<dt>&nbsp;</dt>
					<dd><p class="font12">您现在可以：</p><a href="../../../my/recharge.htm" tppabs="https://xin/my/recharge" class="sub02">充值</a> <a href="../../../invest.shtml.htm" tppabs="https://xin/invest.shtml" class="sub03">投资</a> <a href="../../../my/deposit.htm" tppabs="https://xin/my/deposit" class="sub03">提现</a></dd>
					<div class="clear"></div>
				</dl>
			</div>
		</div>
		<div id="content2" class="tabscontent" style="display:none;">
			<div id="find_safe_pwd_1" class="password_list">
				...
				<dl>
					<dt>您的手机号：</dt>
					<dd><font id="find_safe_pwd_mobile">--</font> <span class="gray paddingleft">若当前号码已不用/丢失，或无法收到验证码？ <a href="../about/contact.shtml.htm" tppabs="https://xin/2.0/views/about/contact.shtml" target="_blank" class="blue">请联系我们</a></span></dd>
					<div class="clear"></div>
				</dl>
				<dl>
					<dt>图形验证码：</dt>
				...
				<dl>
					<dt>设置新密码：</dt>
					<dd><input id="safe_pwd" type="password" class="inputtext" /><span id="safepwd_toggle_btn" class="f-eyes"><img src="../../images/eye_close.png" tppabs="https://xin/2.0/images/eye_close.png" width="36" height="36" /></span>
				...
				<dl>
					<dt>&nbsp;</dt>
					<dd><a id="rest_safe_pwd" href="javascript:void(0)" class="sub02">确 定</a> <span id="rssafepwd_loading" class="gray" style="display:none;"><img src="../../images/loading.gif" tppabs="https://xin/2.0/images/loading.gif" width="16" height="16" /> 正在提交中...</span></dd>
					<div class="clear"></div>
				</dl>
			</div>
			<div id="find_safe_pwd_2" class="password_list" style="display:none">
				...
				<dl class="wordsub">
					<dt>&nbsp;</dt>
					<dd>
						<p class="font12">您现在可以：</p><a href="../../../my/recharge.htm" tppabs="https://xin/my/recharge" class="sub02">充值</a> <a href="../../../invest.shtml.htm" tppabs="https://xin/invest.shtml" class="sub03">投资</a> <a href="../../../my/deposit.htm" tppabs="https://xin/my/deposit" class="sub03">提现</a>
					</dd>
					<div class="clear"></div>
				</dl>
			</div>
		...
		<div id="content3" class="tabscontent" style="display:none;">
			<div class="password_list">
				...
				<dl id="find_name_btn_view">
					<dt>&nbsp;</dt>
					<dd><a id="find_name_next" href="javascript:void(0)" class="sub02">下一步</a> <a id="find_name_send" href="javascript:void(0)" class="sub02" style="display:none;">发送账号</a> <span id="next_loading" class="gray" style="display:none;"><img src="../../images/loading.gif" tppabs="https://xin/2.0/images/loading.gif" width="16" height="16" /> 正在提交中...</span></dd>
				</dl>
				...
				<dl id="find_name_mobile_suc" style="display:none;">
					<dt>&nbsp;</dt>
					<dd><i class="AllIcon icondagou"></i>我们已将登录账号发送到您的认证手机，请查收。 <a href="../../../index.shtml.htm" tppabs="https://xin/index.shtml" class="blue">立即登录</a></dd>
				</dl>
			</div>
		</div>
	</div>
...
<link rel="stylesheet" href="../../css/dialog-wbox.css" tppabs="https://xin/2.0/css/dialog-wbox.css">
<script type="text/javascript" src="../../js/www/account/back_password.js-v=9093" tppabs="https://xin/2.0/js/www/account/back_password.js?v=9093"></script>
</body>
</html>