...
<link href="css/xincunbao.css" tppabs="https://xin/2.0/css/xincunbao.css" rel="stylesheet" type="text/css" />
		...
		<div class="rightContent">
			<div class="earnings block">
				<div class="title">
					...
					<a href="../action/xcb_zt.htm" tppabs="https://xin/action/xcb_zt" target="_blank" class="blue more">了解信存宝></a>
				</div>
				<ul class="details">
					<!--收益展示
				...
				<ul class="transBox">
					...
					<li class="inBox">
						<div class="title">
							...
							<a href="../my/recharge.htm" tppabs="https://xin/my/recharge" target="_blank" class="blue">充值</a>
						</div>
						<div class="inputBox">
							...
							<div class="inputPwCon">
								...
								<a href="views/account/back_password.shtml-tab=2.htm" tppabs="https://xin/2.0/views/account/back_password.shtml?tab=2" target="_blank" class="forgetPw blue">忘记密码?</a>
							</div>
						...
						<div class="agreementLine">
							...
							<span class="agreement">我已阅读并接受<a href="../about/xcb_xieyi.htm" tppabs="https://xin/about/xcb_xieyi" target="_blank" class="blue">《信存宝服务用户协议》</a></span>
						</div>
					</li>
					<!--转出
							账户余额 		#outBalance
					...
					<ul>
						...
						<li>
							<p>
								...
								·  投资真实借款项目 <br/>
								·  随时申退，实时到账 <br/>
								<a href="../action/xcb_zt.htm" tppabs="https://xin/action/xcb_zt" target="_blank">&nbsp;&nbsp;查看信存宝详情></a>   
							</p>
						</li>
					</ul>
				</div>
					...
					<ul>
                        ...
                        <li class="last-child">
							...
							<div>
								<i>A</i>
								<p>
                                信存宝不奖励积分，VIP用户奖励成长值，成长值计算公式本金按存入金额计算，每日发放，具体公式可参看VIP特权。<a href="vip.html" tppabs="https://xin/2.0/vip.html" class="blue" target="_blank">VIP特权详情</a>
								</p>
							</div>
						</li>
					</ul>
...
<link rel="stylesheet" href="css/dialog-wbox.css" tppabs="https://xin/2.0/css/dialog-wbox.css">
<script type="text/javascript" src="js/www/xincunbao.js" tppabs="https://xin/2.0/js/www/xincunbao.js"></script>
<script>
