...
<head>
    <meta charset="UTF-8">
    <title>信融财富 - 安全融资理财平台</title>
    <link rel="stylesheet" href="s/css/global-1.css.css"  />
    <style>
        .g-mod {margin-bottom: 0;}
        .g-mod img {display: block;}
        .error {height: 136px;margin:55px 0 110px 90px;padding-left:250px;background:url("s/img/404.png"/*tpa=http://xin/s/img/404.png*/) no-repeat left top;}
        .error h1 {font-size:16px;font-weight:700;line-height:45px;}
        .error strong,.error li {line-height:30px}
        .error a.blue {margin-left: 13px;}
    </style>
    <script>var G_ENV_VAR = {WWW:'index.htm'/*tpa=http://xin/*/,STATIC:'http://s.xinrong.com/',BBS:'http://bbs.xinrong.com/',UID:'',UNAME:'',MSG_NUM:'',VIP: '',IS_CHECKED_EMAIL: false,IS_CHECKED_MOBILE: false,HAS_TRADE_PASSWORD: false,IS_CHECKED_IDENTIFICATION: false,IS_CHECKED_BANKCARD: false}</script>
<script src="s/js/lib/jquery.min-1.js" ></script>
<script src="s/js/AA.base-min-1.js" ></script>
<script type="text/javascript" src="2.0/js/rsa-1.js" ></script>
</head>
<body>
<style>
.FontBg{}
        ...
        <ul class="top-menu g-fix">
            ...
            <li class="menu-item toolbox"><a href="javascript:;" class="menu-hd" rel="nofollow">计算器<i class="arrow"></i></a>
                <ul class="menu-bd g-hide">
                    <li><a target="_blank" href="http://xin/toolbox/caculator">利息计算器</a></li>
                </ul>
            </li>
        </ul>
	...
	function show_weixin(){
		...
		var drd= $.popup1({
           ...
           content:'<div class="weixingbox" >\
               ...
               <div class="BoxClose"><a href="javascript:close_weixin();"><img src="s/img/close-1.jpg"/*tpa=http://xin/s/img/close.jpg*/ /></a></div>\
               <div class="boxpic"><img src="s/img/w02-1.jpg"/*tpa=http://xin/s/img/w02.jpg*/ /><div class="boxfont"><span style="color:#0078b6;">服务号：</span>扫描或在微信添加公众号<br/>搜索<span>信融财富</span>关注</div>\</div>\
               <div class="boxpic"><img src="s/img/w05-1.jpg"/*tpa=http://xin/s/img/w05.jpg*/ width="232" /><div class="boxfont"><span style="color:#0078b6;">订阅号：</span>扫描或在微信添加公众号搜<br/>索<span>信融财富投融资平台</span>关注</div>\</div>\
               </div>\
               </div>',
	...
	function show_App(){
		...
		var drd= $.popup1({
           ...
           content:'<div class="weixingbox appbox">\
               <div class="boxbg"><h2><img src="s/img/App-1.jpg"/*tpa=http://xin/s/img/App.jpg*/ /><span>iPhone</span>版客户端</h2>\
               <div class="BoxClose" style="display: none"><a href="javascript:close_App();"><img src="s/img/close-1.jpg"/*tpa=http://xin/s/img/close.jpg*/ /></a></div>\
               <div class="boxpic"><img src="s/img/w03-1.jpg"/*tpa=http://xin/s/img/w03.jpg*/ /></div>\
               <div class="boxfont boxApp">扫描或在AppStore搜索"<span>信融财富</span>"下载</div>\
               </div>\
			   <div class="boxbg"><h2><img src="s/img/android-1.jpg"/*tpa=http://xin/s/img/android.jpg*/ /><span>Android</span>版客户端</h2>\
               <div class="BoxClose"><a href="javascript:close_App();"><img src="s/img/close-1.jpg"/*tpa=http://xin/s/img/close.jpg*/ /></a></div>\
               <div class="boxpic"><img src="s/img/w04-1.jpg"/*tpa=http://xin/s/img/w04.jpg*/ /></div>\
...
.hmenu_nav ul li a .iconhot{ width:26px; height:16px; display:inline-block; background:url("2.0/images/hot-1.png"/*tpa=http://xin/2.0/images/hot.png*/) no-repeat; position:absolute; right:10px; top:5px;}
.hmenu_nav ul li a .hh_icon{ width:34px; height:21px; display:inline-block; position:absolute; right:3px; top:-2px;}
.hmenu_nav ul li a .arrow{ width:13px; height:8px; display:inline-block; vertical-align:middle; background:url("2.0/images/t-n-1.png"/*tpa=http://xin/2.0/images/t-n.png*/) no-repeat; margin-left:5px;}
.hmenu_nav ul li:hover a{ color:#f60; text-decoration:none;}
.hmenu_nav ul li:hover a .arrow{ background:url("2.0/images/t-n-1.png"/*tpa=http://xin/2.0/images/t-n.png*/) no-repeat; transform:rotate(180deg); -ms-transform:rotate(180deg); -moz-transform:rotate(180deg); -webkit-transform:rotate(180deg); -o-transform:rotate(180deg);}
.hmenu_nav ul li.cur a{ color:#fff; background:#f60;}
.hmenu_nav ul li.cur a .arrow{ background:url("2.0/images/t-n01-1.png"/*tpa=http://xin/2.0/images/t-n01.png*/) no-repeat; transform:rotate(180deg); -ms-transform:rotate(180deg); -moz-transform:rotate(180deg); -webkit-transform:rotate(180deg); -o-transform:rotate(180deg);}
...
<div class="hmenu_nav">
  <div class="main PositionR">
    <div class="logo left PositionR"><a href="index.htm" ><img src="2.0/images/logo-1.gif"  /></a><a href="2.0/views/about/shareholder-1.shtml.htm"  class="logo_font">上市公司系</a></div>
    <div class="right top_my"><a href="2.0/views/account/account_index-1.shtml.htm"  class="f-my" id="nav_my">我的账户</a> <a id="j-logout" href="javascript:if(confirm('http://xin/logout  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ������������ļ�δ�ҵ���  \n\n�����ڷ������ϴ���?'))window.location='http://xin/logout'"  class="f_exit" style="display:none;">退出</a><span class="h-login-reg h-login"><i></i><a href="2.0/login2.0-1.html"  class="flogin">登录</a><a href="2.0/views/account/register4.0-1.shtml.htm"  class="freg">注册</a></span></div>
    <div class="clear"></div>
  </div>
...
$(function(){
    ...
    <div class="g-grid">
        <div class="g-mod error">
            <h1>很抱歉，您访问的页面不存在！</h1>
            <strong>您可以：</strong>
            <ul>
                <li>1、检查您输入的链接是否正确</li>
                <li>2、去其他页面看看：
                    <a href="index.htm"  class="blue">返回首页</a>
                    <a href="invest-1.shtml.htm"  class="blue">投资理财</a>
                </li>
            </ul>
        </div>
        <div class="g-mod">
            <a href="action/reg_invite.htm"  target="_blank"><img src="s/img/a/201301191036_1000x83-1.jpg.jpg"   alt="信融财富火热上线三重礼！" title="信融财富火热上线三重礼！"  /></a>
        </div>
    </div>
</div>
<div class="clear"></div>
...
<ul>
<li><h2><a href="2.0/views/about/about-1.shtml.htm"  target="_blank">关于我们</a></h2><p><a href="2.0/views/about/team-1.shtml.htm"  target="_blank">团队介绍</a></p><p><a href="2.0/views/about/xr_history-1.shtml.htm"  target="_blank">发展历程</a></p><p><a href="2.0/views/about/xr_credit-1.shtml.htm"  target="_blank">资质荣誉</a></p><p><a href="2.0/views/about/partner-1.shtml.htm"  target="_blank">合作机构</a></p></li>
<li><h2><a href="2.0/views/about/help-1.shtml.htm"  target="_blank">帮助中心</a></h2><p><a href="2.0/views/about/guide/guide1-1.shtml.htm"  target="_blank">新手指引</a></p><p><a href="2.0/views/about/help-2.shtml.htm"  target="_blank">问题答疑</a></p><p><a href="2.0/views/about/help-3.shtml.htm"  target="_blank">投资攻略</a></p><p><a href="javascript:if(confirm('http://bbs.xinrong.com/forum-49-1.html  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.xinrong.com/forum-49-1.html'"  target="_blank">意见反馈</a></p></li>
<li><h2><a href="2.0/views/about/about-1.shtml.htm" target="_blank">信息中心</a></h2><p><a href="2.0/views/about/xr_announcement-1.shtml.htm"  target="_blank">平台公告</a></p><p><a href="2.0/views/about/media_report-1.shtml.htm"  target="_blank">媒体报道</a></p><p><a href="2.0/views/about/activitysum-1.shtml.htm"  target="_blank">信融点滴</a></p><p><a href="javascript:if(confirm('http://bbs.xinrong.com/forum.php  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://bbs.xinrong.com/forum.php'"  target="_blank">社 区</a></p></li>
<li><h2>产品体系</h2><p><a href="2.0/vip-1.html"  target="_blank">VIP特权</a></p><p><a href="javascript:if(confirm('http://xin/gift  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ������������ļ�δ�ҵ���  \n\n�����ڷ������ϴ���?'))window.location='http://xin/gift'"  target="_blank">积品汇</a></p><p><a href="action/jf.htm"  target="_blank">抽奖</a></p></li>
</ul>
</div>
...
<ul class="weix_box"><b></b><li><p><img src="s/img/w02-1.jpg"  width="100"></p><h4>关注服务号</h4></li><li><p><img src="s/img/w05-1.jpg"  width="100"></p><h4>关注订阅号</h4></li><li><p><img src="s/img/w06-1.jpg" width="100"></p><h4>微信客服-小薇</h4></ul>
</li>
...
<li><b></b><p><img src="2.0/images/qq-1.png"  width="120"></p><h4>QQ号：4007779888</h4></li>
</ul></li>
...
<div class="footer_app right">
  <img src="s/img/w07-1.jpg"  width="122" class="bimg" /><h2>下载手机客户端<i class="AllIcon icon01"></i> <i class="AllIcon icon02"></i></h2> </div>
...
<div class="clear"></div>
<div class="footer_font main"><p> <a href="javascript:if(confirm('http://xin/about/privacy  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ������������ļ�δ�ҵ���  \n\n�����ڷ������ϴ���?'))window.location='http://xin/about/privacy'"  target="_blank">隐私保护申明</a> 　|　 <a href="javascript:if(confirm('http://xin/about/agreement  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ������������ļ�δ�ҵ���  \n\n�����ڷ������ϴ���?'))window.location='http://xin/about/agreement'"  target="_blank">服务协议</a>　 |　 粤ICP备12020226号</p>Copyright Xinrong.com All Rights Reserved   信融财富投资管理有限公司</div>
</div>
...
$(function(){
		...
		$.dialog({
			...
			initialize:function(){
				...
				$('.d-dialog #free_tel_btn').click(function(){
					$.ajax({
						url:'v2/communication/free_consulation-1.jso'/*tpa=http://xin/v2/communication/free_consulation.jso*/,
						type:'post',
						dataType:'json',
	...
	$.ajax({
		url:'v2/login/in_session_data-1.jso'/*tpa=http://xin/v2/login/in_session_data.jso*/,
	    type:'GET' ,
	    dataType:'json',
	    success:function (result) {
	    	if(result.state==0){
...
<script src="s/vendor/artDialog/jquery.artDialog-min-1.js" ></script>
<script src="s/vendor/artDialog/dialog_ex-1.js" ></script>
<script src="s/js/biz/dlg_login-min-1.js" ></script>
<input type="hidden" id="login_redirect" value=""/>
<script>AA.View.TopNav.init();</script>


<script type="text/javascript" src="2.0/js/channel-1.js" ></script> 
...
(function() {
	...
	if(agent.indexOf('android')==-1&&agent.indexOf('Android')==-1){
		...
		hm.src = "../hm.baidu.com/hm-1.js"/*tpa=http://hm.baidu.com/hm.js?a5ef11ea1e672f6b504ec7fe5a92cf30*/;
