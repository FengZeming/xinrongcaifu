        	...
        	<form class="form-signin">
	      	...
	      	<div class="row">
	      		<div class="col-md-4 col-md-offset-4">
	      			<h2 class="form-signin-heading">申请融资项目</h2>
	      		</div>
	      	</div>
	      	
	      	<div class="row">
	      		<div class="col-md-1 col-md-offset-3"><p class="form-control-static">融资系列</p></div>
	      		<div class="col-md-4">
	      			<label for="selectSeires" class="sr-only" >系列</label>
	      			<select name="seriesid" id="selectSeires" class="form-control">
	      				<option value="0">--请选择融资系列--</option>
	      			</select>
	        	</div>
	      	</div>
...
<div class="main">
<h1 class="invest_title"><span>轻松融资，稳赚收益</span></h1>
</div>
