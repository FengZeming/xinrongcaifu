...
<link href="2.0/css/banner.css"  rel="stylesheet" type="text/css" />
<link href="2.0/css/index_new.css"  rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="2.0/js/jquery.SuperSlide.js" ></script>
<script type="text/javascript" src="2.0/js/jquery.featureCarousel.js" ></script>
<script type="text/javascript" src="2.0/js/vendor/animateNumber/jquery.animateNumber.js" ></script>
<script type="text/javascript" src="2.0/js/vendor/echarts/build/dist/echarts.js" ></script>
...
<script type="text/javascript" src="2.0/js/h-proanimate.js" ></script>
...
<script type="text/javascript" src="2.0/js/mod/fare_recharge.js" ></script>
...
<div class="focus" id="focus">
  <div class="login_box">
    <div class="login login_one">
      ...
      <a href="2.0/views/account/register4.0.shtml.htm"  class="sub02">立即注册</a>
...
<div class="h_product">
  ...
  <div class="h_prolist main">
     <div class="h_p_left left PositionR"><span class="double" style="display:none;"><a href="2.0/action/xr_double/xr_depository.shtml.htm" target="_blank" style="display: inline-block;"><img src="2.0/images/double01.png"  /></a></span> <span class="l_pic">
      <h2>信·项目</h2>
      <p>产品丰富<br />
        风控严谨<br />
        信息透明</p>
    ...
    <div id="tabsholder" class="h_p_right left">
      <ul class="tabs">
        ...
        <a id="series" href="invest.shtml.htm"  class="more" target="_blank">更多项目></a>
      </ul>
      		...
      		<div id="botton_scroll_1">
	            ...
	            <c:forEach var="project" items="${list1 }">
	            	<dl onclick="window.open('2.0/detail.shtml.htm')" style="overflow: hidden; float: left; width: 277px; height: 355px;">
	            		<dt>									
	            			<span class="p_day">${project.projectfinancingtime }<span>月</span></span>
	            			<h2>${project.expectedannualized*100 }<span>%</span><span class="f-raise">+<b>1.20%</b></span></h2><p>预期年化收益率</p>
	            		</dt>								
	            		<dd>									
	            			<p>剩余可投：<span class="orange">${project.expectedfinancingamount-project.actualfinancingamount }元</span></p>
	            			<p>${project.projectname }</p>
	            			<p class="p_pic"><a href="/about/partner/2" target="_blank"><i class="danbao" title="第三方公司本息担保">担保</i></a>&nbsp;<i class="jiang">奖</i>&nbsp;</p>
	            			<span class="t-f">100元起投<p>${project.receivablewayName }</p></span>
...
<ul>
<li><img src="2.0/images/about/partner/rong360.jpg"  height="40" /></li>
<li class="wp"><img src="2.0/images/about/partner/huazhen.jpg"  height="40" /></li>
<li><img src="2.0/images/about/partner/fengchelicai.jpg"  height="40" /></li>
<li><img src="2.0/images/about/partner/fenqix.jpg"  height="40" /></li>
<li><img src="2.0/images/about/partner/touzhijia.png"  height="40" /></li>
<li class="wp"><img src="2.0/images/about/partner/zhima01.jpg"  height="40" /></li>
<li><img src="2.0/images/about/partner/lsign.png"  height="40" /></li>
<li><img src="2.0/images/about/partner/ebaoquan.png"  height="40" /></li>
<li><img src="2.0/images/about/partner/lianjian.jpg"  height="40" /></li>
<li class="wp"><img src="2.0/images/about/partner/tongdun.png" height="40" /></li>
<li><img src="2.0/images/about/partner/tenpay.jpg"  height="40" /></li>
<li><img src="2.0/images/about/partner/huawei.jpg"  height="40" /></li>
</ul>
...
<li><a target="_blank" href="javascript:if(confirm('https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf%2Fsplash.fdf&sap=&dn=www.xinrong.com&zoneoff=&lang=zh_CN  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf%2Fsplash.fdf&sap=&dn=www.xinrong.com&zoneoff=&lang=zh_CN'"  title="信融财富是中国首批引入VeriSign 256位SSL加密的融资理财平台。您的隐私及个人资料安全已受最高级别的保护。"><i class="icon03"></i></a></li>
...
<li><a target="_blank" href="javascript:if(confirm('http://v.pinpaibao.com.cn/authenticate/cert/?site=www.xinrong.com&at=business  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://v.pinpaibao.com.cn/authenticate/cert/?site=www.xinrong.com&at=business'"  title="安全联盟认证网站"><i class="icon06"></i></a></li>
</ul>
</div>
<div class="clear"></div>
...
<dl>
	<dt>友情链接:</dt>
		<dd>
			...
			<ul class="linklist">
        		<li><a href="javascript:if(confirm('http://www.gifa.com.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.gifa.com.cn/'"  target="_blank" rel="nofollow">广东互联网金融协会</a> <a href="javascript:if(confirm('http://www.szifa.org.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.szifa.org.cn/'"  target="_blank">深圳互金协会</a> <a href="javascript:if(confirm('https://www.tenpay.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.tenpay.com/'" target="_blank" rel="nofollow">财付通</a> <a href="javascript:if(confirm('http://www.szhuazhen.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.szhuazhen.com/'"  target="_blank">华圳担保</a> <a href="javascript:if(confirm('http://www.wdzj.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.wdzj.com/'"  target="_blank">网贷之家</a> <a href="javascript:if(confirm('http://www.rong360.com/licai/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.rong360.com/licai/'"  target="_blank">融360理财</a> <a href="javascript:if(confirm('http://www.touzhijia.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.touzhijia.cn/'" target="_blank">投之家</a> <a href="javascript:if(confirm('http://www.xinrongcaifu.com/baoxian.html  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.xinrongcaifu.com/baoxian.html'" target="_blank">保险购买</a> <a href="javascript:if(confirm('https://www.fengchelicai.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.fengchelicai.com/'"  target="_blank">风车理财</a> <a href="javascript:if(confirm('http://www.jpm.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.jpm.cn/'"  target="_blank">金评媒</a> <a href="javascript:if(confirm('http://www.xeenho.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.xeenho.com/'"  target="_blank">星火钱包</a> <a href="javascript:if(confirm('https://www.fenqix.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://www.fenqix.com/'"  target="_blank">分期X</a> <a href="wen/index.htm" target="_blank">信融资讯</a> <a href="2.0/action/xr_huahua/huahua.shtml.htm"  target="_blank">信融花花</a></li>
        		<li style="" id="morehide"><a href="zixun/licaizixun/index.htm"  target="_blank">理财资讯</a> <a href="zixun/P2Pzixun/index.htm" target="_blank">P2P网贷</a> <a href="zixun/rongzizixun/index.htm"  target="_blank">如何融资</a> <a href="zixun/index.htm" target="_blank">理财资讯</a> <a href="tags.html"  target="_blank">标签列表</a> <a href="javascript:if(confirm('http://home.sz.fang.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://home.sz.fang.com/'"  target="_blank">深圳装修</a> <a href="javascript:if(confirm('http://www.kameng.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.kameng.com/'"  target="_blank">信用卡卡盟</a> <a href="zixun/index.htm" target="_blank">网贷资讯</a> <a href="zixun/index-1.htm"  target="_blank">网贷新闻</a> <a href="javascript:if(confirm('http://www.xinrongcaifu.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.xinrongcaifu.com/'"  target="_blank">信融财富综合</a> <a href="javascript:if(confirm('http://www.01caijing.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.01caijing.com/'"  target="_blank">零壹财经</a> <a href="javascript:if(confirm('http://www.cnbzol.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.cnbzol.com/'"  target="_blank">巴中在线</a> <a href="javascript:if(confirm('http://www.jfz.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.jfz.com/'" target="_blank">金斧子财富</a>
                <p><a href="javascript:if(confirm('http://www.pcben.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.pcben.com/'" target="_blank">理财小知识</a> <a href="javascript:if(confirm('http://www.dncjw.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.dncjw.com/'"  target="_blank">股票入门</a> <a href="javascript:if(confirm('http://www.trustores.cn/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.trustores.cn/'"  target="_blank">资管产品</a> <a href="javascript:if(confirm('https://money.gucheng.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://money.gucheng.com/'"  target="_blank">股城理财</a> <a href="javascript:if(confirm('http://www.tayouqian.com/  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ�����ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='http://www.tayouqian.com/'"  target="_blank">他有钱</a> </p></li>
        	</ul>
        </dd>
        <div class="clear"></div>
	</dl>
...
<div id='step_1' style='display:none'>
	...
	<dt>&nbsp;</dt>
	<dd><a href="javascript:void(0)" class="sub01" onclick='fare.commit()'>确认充值</a><a href="2.0/vip.html"  target="_blank" class="sub02" >查看详情></a></dd>
	<div class="clear"></div>
	</dl>
	</div>
</div>
<div id='step_2' style='display:none'>
	...
	<dl>
	<dt>交易密码：</dt>
	<dd><input id='tradePwd' type="password" class="text01" placeholder="" /> <a target="_blank" href="2.0/views/account/back_password.shtml-tab=2.htm"  class="blue">忘记交易密码？</a></dd>
	<div class="clear"></div>
	</dl>
	<dl class="paddintbottom">
	<dt>验证码：</dt>
...
<a href="javascript:wBox.close()" class="close"><img src="2.0/images/pc_app_closeBanner.png" width="100" /></a>
<p><img src="2.0/images/i_01.png"  /></p>
<ul>
<li><a href="webapp2.0/index.htm" ><img src="2.0/images/73.png"  width="120" /><p>触屏版</p></a></li>
<li><a href="javascript:void(0)" id="app_download_url"><img src="2.0/images/74.png"  width="120" /><p>APP下载</p></a></li>
<div class="clear"></div>
</ul>
...
<div class="qq_diabox">
<img src="2.0/images/qq.png"  width="258" />
<p>QQ号：4007779888</p>
</div>
</div>
...
<script type="text/javascript" src="2.0/js/banner.js" ></script>
<link href="webapp2.0/css/wbox.css"  rel="stylesheet" type="text/css" />
<script type="text/javascript" src="webapp2.0/js/wbox.js" ></script>
<script type="text/javascript" src="2.0/js/www/index_new.js" ></script>
<script type="text/javascript">
