...
<div class="form-header">
    <h3><a href="consume.htm" tppabs="https://xin/my/consume" class="consume current">收支明细</a></h3>
    <h3><a href="in.htm" tppabs="https://xin/my/in" class="in">充值记录</a></h3>
    <h3><a href="out.htm" tppabs="https://xin/my/out" class="last out">提现记录</a></h3>
...
<input type="hidden" id="time" value="3"/>        <label for="ttype" style="margin-left:48px;">类型：</label>
        <select name="ttype" id="ttype">
            ...
            <option value="7">投资礼金</option>
            <option value="8">投资服务费</option>
        </select>
...
<input type="hidden" id="etime" name="etime" value=""/>    </div>
    ...
    <thead class="wgt-datagrid-header">
    	<tr><th class="date first">交易时间</th><th class="type">交易类型</th><th class="sn">流水号</th> <th class="in g-money">收入</th><th class="out g-money">支出</th><th class="blance g-money">账户余额</th><th class="remark last">备注</th></tr>
    </thead>
    <tbody class="wgt-datagrid-container">
    	<tr><td align="center">2017-09-12 21:13:00</td><td align="center">礼金赠送</td><td align="center">16021255825</td><td align="center" class="g-money"><strong>+3.00</strong>&nbsp;元</td><td align="center" class="g-money"></td><td align="center">0.00 元</td><td align="center">投资礼金余额13.00元</td></tr>
    	<tr class="odd"><td align="center">2017-09-12 21:13:00</td><td align="center">礼金赠送</td><td align="center">16011255825</td><td align="center" class="g-money"><strong>+10.00</strong>&nbsp;元</td><td align="center" class="g-money"></td><td align="center">0.00 元</td><td align="center">投资礼金余额10.00元</td></tr>
    </tbody>
</table>
    <div class="wgt-pagination">
    	<span class="wgt-pagination-info">共 <b class="g-out">2</b> 笔收支明细：收入 2 笔，共 <b class="g-out">13.00</b> 元；支出 0 笔，共 <b class="g-out">0</b> 元。</span>
    </div></div>        </div>
    </div>
</div>
<div class="clear"></div>
...
<script>AA.User.Consume.Detail.init();</script>
</body>
</html>
  </body>
</html>
