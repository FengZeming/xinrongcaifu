...
<div class="form-header">
    ...
    <h3><a href="in.htm" tppabs="https://xin/my/in" class="in current">充值记录</a></h3>
...
<input type="hidden" id="etime" name="etime" value=""/>    </div>
    ...
    <thead class="wgt-datagrid-header">
    	<tr><th class="date first">充值时间</th><th class="way">充值方式</th><th class="sn">流水号</th><th class="recharge g-money"> 充值金额</th><th class="account g-money">到账金额</th><th class="fee">手续费</th><th class="state last">状态</th></tr>
    </thead>
    <tbody class="wgt-datagrid-container">
    	<tr><td align="center">2017-09-12 22:00:00</td><td align="center">银行卡充值</td><td align="center">16666666666</td><td align="center" class="g-money"><strong>500.00</strong>元</td><td align="center" class="g-money">500.00 元</td><td align="center">5.00元</td><td align="center">已到账</tr>
    		<tr><td align="center">2017-09-12 23:00:00</td><td align="center">微信支付</td><td align="center">18888888888</td><td align="center" class="g-money"><strong>500.00</strong>元</td><td align="center" class="g-money">500.00 元</td><td align="center">5.00元</td><td align="center">已到账</tr>
    	<!--<tr><td colspan="7" class="wgt-datagrid-empty-row">暂无充值记录</td></tr>-->
    </tbody>
</table>
    <div class="wgt-pagination">
    	<span class="wgt-pagination-info">共 <b class="g-out">0</b> 笔充值记录：充值 2 笔，共 <b class="g-out">1000</b> 元；</span>
    </div></div>        </div>
    </div>
</div>
<div class="clear"></div>
...
<script>AA.User.Consume.In.init();</script>
</body>
</html>
  </body>
</html>
