...
<div class="hmenu_nav">
  <div class="main PositionR">
    ...
    <div class="right top_my"><a href="../2.0/views/account/account_index.htm"  class="f-my" id="nav_my">我的账户</a> <a id="j-logout" href="../index.shtml.htm"  class="f_exit" style="display:none;">退出</a><span class="h-login-reg h-login"><i></i><a href="../2.0/login2.0.html"  class="flogin">登录</a><a href="../2.0/views/account/register4.0.shtml.htm"  class="freg">注册</a></span></div>
    <div class="clear"></div>
  </div>
...
<div class="side-nav g-well g-left">
    ...
    <div class="ui-tip info" style="color:#999;">实收收益中已扣除投资服务费 <a href="../2.0/views/about/help.shtml-tab=tab3&href=c1.htm"  class="blue" target="_blank">细则</a></div>
    ...
    <div style="margin-left: 15px;">
   	...
   	<div style="margin-left: 15px;">
	   	...
	   	<div style="margin-top: 20px;">
	   		<span style="font-weight: bold;">您在信融财富已累计获得 <font color="red" id="all">500</font> 元收益 !<span class="invest_msg"><img src="../s/images/info.png"  /><span class="i-title"><b><img src="../2.0/images/bicon.png" ></b>不包含投资未回款收益</span></span></span>
	   	</div>
   	</div>
    ...
    <div class="wgt-dialog wgt-dialog-loan-info">
        <div class="loan-info">
            ...
            <div class="section">
                ...
                <p>违约代偿方式：VIP会员逾期下一工作日全额本息代偿，普通用户逾期30日后全额本息代偿。 <a href="../help/faq/2.htm#8"  class="blue" target="_blank">查看细则</a></p>
            </div>
        </div>
        <div class="serve-intro">
            <h4>服务简介</h4>
            <p class="ti bk">信<i class="g-dian">·</i>无忧贷是信融财富为投资人和融资方打造的投融资中介服务。该服务以投资人利益为出发点，力争为投资人提供一款有安全保障、省时省心、且收益可观的服务旗舰品。信<span class="g-dian">·</span>无忧贷作为服务提供方，负责协调融资方、投资人以及担保方，并作为见证方见证以上各方的投融资和担保行为。  <a href="../about/introduction.htm"  class="more blue" target="_blank">了解更多></a></p>
        </div>
    </div>
</div>
            ...
            <tr>
                ...
                <td rowspan="2" style="padding-top:30px;">
                    ...
                    <p>（收益的<span class="rate"></span>%）</p>
                        ...
                        <a href="../2.0/vip.html"  class="blue" target="_blank">详情</a>
                    </span>
                                    </td>
            </tr>
            <tr>
...
<ul>
    ...
    <li class="w02 gray">vip等级越高，积分价值越高 <a href="../gift-flag=vipChangeInfo.htm#gift_type_4"  class="red">兑换礼金></a></li>
	<div class="clear"></div>
</ul>
<ul class="bor">
...
<script src="../s/js/v2/user/trans.js-v=1591" ></script>
<script src="../s/js/v2/user/refund_plan.js-v=1591" ></script>
<script src="../s/js/v2/user/trans_detail.js-v=1591" ></script>
