...
<link rel="stylesheet" href="../s/css/www/user.css-v=1591.css" tppabs="https://xin/s/css/www/user.css?v=1591" />
    <style>.d-buttons {display: block;}</style>
...
<div class="side-nav g-well g-left">
    ...
    <h3 ><a id="side-nav-msg" class="item current" href="msg.htm" tppabs="https://xin/my/msg">我的消息</a></h3>
</div>        <div class="main-section g-right">
            <div class="msg-header">
                <h2>信融财富通知消息</h2>
                                <label for="msgtype">筛选
            ...
            <div class="g-mod msg-list">
    <ul>
    </ul>
    <div class="wgt-pagination"></div></div>        </div>
    </div>
</div>
<div class="clear"></div>
...
<script>AA.User.Msg.init();</script>
</body>
</html>
  </body>
</html>
