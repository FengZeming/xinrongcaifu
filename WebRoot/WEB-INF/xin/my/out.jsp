...
<div class="hmenu_nav">
  <div class="main PositionR">
    ...
    <div class="right top_my"><a href="../2.0/views/account/account_index.shtml.htm"  class="f-my" id="nav_my">我的账户</a> <a id="j-logout" href="../index.htm" class="f_exit" style="display:none;">退出</a><span class="h-login-reg h-login"><i></i><a href="../2.0/login2.0.html"  class="flogin">登录</a><a href="../2.0/views/account/register4.0.shtml.htm"  class="freg">注册</a></span></div>
    <div class="clear"></div>
  </div>
...
<div class="form-header">
    <h3><a href="consume.htm"  class="consume">收支明细</a></h3>
    <h3><a href="in.htm"  class="in">充值记录</a></h3>
    <h3><a href="out.htm"  class="last out current">提现记录</a></h3>
