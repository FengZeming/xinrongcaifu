...
.hmenu_nav ul li a .iconhot{ width:26px; height:16px; display:inline-block; background:url("../2.0/images/hot.png"/*tpa=https://xin/2.0/images/hot.png*/) no-repeat; position:absolute; right:10px; top:5px;}
.hmenu_nav ul li a .hh_icon{ width:34px; height:21px; display:inline-block; position:absolute; right:3px; top:-2px;}
.hmenu_nav ul li a .arrow{ width:13px; height:8px; display:inline-block; vertical-align:middle; background:url("../2.0/images/t-n.png"/*tpa=https://xin/2.0/images/t-n.png*/) no-repeat; margin-left:5px;}
.hmenu_nav ul li:hover a{ color:#f60; text-decoration:none;}
.hmenu_nav ul li:hover a .arrow{ background:url("../2.0/images/t-n.png"/*tpa=https://xin/2.0/images/t-n.png*/) no-repeat; transform:rotate(180deg); -ms-transform:rotate(180deg); -moz-transform:rotate(180deg); -webkit-transform:rotate(180deg); -o-transform:rotate(180deg);}
.hmenu_nav ul li.cur a{ color:#fff; background:#f60;}
.hmenu_nav ul li.cur a .arrow{ background:url("../2.0/images/t-n01.png"/*tpa=https://xin/2.0/images/t-n01.png*/) no-repeat; transform:rotate(180deg); -ms-transform:rotate(180deg); -moz-transform:rotate(180deg); -webkit-transform:rotate(180deg); -o-transform:rotate(180deg);}
...
<div class="hmenu_nav">
  <div class="main PositionR">
    <div class="logo left PositionR"><a href="../index.htm" tppabs="https://xin/index"><img src="../2.0/images/logo.gif" tppabs="https://xin/2.0/images/logo.gif" /></a><a href="../2.0/views/about/shareholder.shtml.htm" tppabs="https://xin/2.0/views/about/shareholder.shtml" class="logo_font">上市公司系</a></div>
    <div class="right top_my"><a href="../2.0/views/account/account_index.shtml.htm" tppabs="https://xin/2.0/views/account/account_index.shtml" class="f-my" id="nav_my">我的账户</a> <a id="j-logout" href="../index.htm" tppabs="https://xin/logout" class="f_exit" style="display:none;">退出</a><span class="h-login-reg h-login"><i></i><a href="../2.0/login2.0.html" tppabs="https://xin/2.0/login2.0.html" class="flogin">登录</a><a href="../2.0/views/account/register4.0.shtml.htm" tppabs="https://xin/2.0/views/account/register4.0.shtml" class="freg">注册</a></span></div>
    <div class="clear"></div>
  </div>
...
<style type="text/css">.side-nav #side-nav-zz b.iconReward{ width:26px; height:18px; 	background-image: url("../2.0/images/account/reward/prise.png"/*tpa=https://xin/2.0/images/account/reward/prise.png*/);display:inline-block; margin:0 0 5px 5px;}</style>
<div class="side-nav g-well g-left">
    ...
    <h3><a id="side-nav-consume" class="item current" href="consume.htm" tppabs="https://xin/my/consume">收支查询</a></h3>
...
<div class="form-header">
    <h3><a href="consume.htm" tppabs="https://xin/my/consume" class="consume">收支明细</a></h3>
    <h3><a href="in.htm" tppabs="https://xin/my/in" class="in">充值记录</a></h3>
    <h3><a href="out.htm" tppabs="https://xin/my/out" class="last out current">提现记录</a></h3>
</div>            <div class="g-mod consume-form form-container">
    <div class="search">
        <label for="ttime" class="first">时间：</label>
...
<input type="hidden" id="time" value="3"/>        <div class="pk-time g-hide">
...
<input type="hidden" id="etime" name="etime" value=""/>    </div>
    ...
    <thead class="wgt-datagrid-header">
    	<tr><th class="date first">申请提现时间</th><th class="card">提现银行卡</th><th class="sn">流水号</th><th class="deposit g-money"> 提现金额</th><th class="account g-money">到账金额</th><th class="fee">手续费</th><th class="state last">状态</th></tr>
    </thead>
    <tbody class="wgt-datagrid-container">
    	<tr><td align="center">2017-09-12 17:00:00</td><td align="center">中国建设银行</td><td align="center">17777777777</td><td align="center" class="g-money"><strong>5000.00</strong>元</td><td align="center" class="g-money">4990.00 元</td><td align="center">10.00元</td><td align="center">已到账</tr>
    		<tr><td align="center">2017-09-12 18:00:00</td><td align="center">中国农业银行</td><td align="center">19999999999</td><td align="center" class="g-money"><strong>5000.00</strong>元</td><td align="center" class="g-money">4990.00 元</td><td align="center">10.00元</td><td align="center">已到账</tr>
    	<tr><td colspan="7" class="wgt-datagrid-empty-row">暂无提现记录</td></tr>
    </tbody>
</table>
    <div class="wgt-pagination">
    	<span class="wgt-pagination-info">共 <b class="g-out">0</b> 笔提现记录：提现2笔，共 <b class="g-out">9980</b> 元；</span>
    </div></div>        </div>
    </div>
</div>
<div class="clear"></div>
...
<script>AA.User.Consume.Out.init();</script>
</body>
</html>
  </body>
</html>
