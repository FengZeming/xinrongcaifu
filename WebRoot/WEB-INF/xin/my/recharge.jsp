...
<div class="side-nav g-well g-left">
    ...
    <h3><a href="<%=request.getContextPath()%>/xin/my/deposit.htm"  class="last deposit">提现</a></h3>
</div>            <style>
    ...
    <fieldset class="ui-form">
        <form id="recharge-form" method="post" target="_blank" action="https://xin/v2/charge/do_recharge.raw" >
            ...
            <div class="ui-form-line money" style="height:auto">
              ...
              <!--   <div class="rechargefont"><dl><dt>选择方式：</dt><dd><ul><li class="hoverbg bor"><a href="recharge.htm" >有网银大额支付</a></li><li><a href="rechargec.htm" >无网银快捷支付</a></li></ul></dd></dl><div style="clear:both"></div></div>
                 -->
                ...
                <span>财付通故障暂停充值</span>
                -->
                <span style="color: gray;font-size: 14px;" >关注信融服务号 资金动态一手掌握<span class="t-hover"><img src="../2.0/images/t-j04.png"  id="showRechargeXrWeixin" /><i><img src="../s/img/w02.jpg"  /></i></span></span>
                <em class="ui-tip" style="margin-left:20px;"></em>
                </div>
				<p class="ui-tip info">为了您的资金安全，请尽快开通财付通账号并实名认证。<br />充值后未投资的资金提现将收取额外0.5%手续费。<a href="../2.0/views/about/help.shtml-tab=tab2&href=b6.htm"  target="_blank" class="blue">详情</a></p>
			                   ...
			                   <label for="psbc5">
			                      <input type="radio" id="bankType" name="bankType" value="baofu_3005"/>
			                       <!--<input type="radio" id="bankType" name="bankType" value="ys_1031000"/>
			                         --><img src="../s/img/banks/abc.gif-v=1591.gif"   width="100" height="20"  alt="中国农业银行" title="中国农业银行"  />			                            </label>
			                        </li>
			                       ...
			                       <li class="bank">
			                         ...
			                         <img src="../s/img/banks/icbc.gif-v=1591.gif"   width="100" height="20"  alt="中国工商银行" title="中国工商银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="ccb5">
			                             <input type="radio" id="bankType" name="bankType" value="baofu_3003"/> 
			                          <!--<input type="radio" id="bankType" name="bankType" value="ys_1051000"/>-->
			                            <img src="../s/img/banks/ccb.gif-v=1591.gif"   width="100" height="20"  alt="中国建设银行" title="中国建设银行"  />			                            </label>
			                        </li>
			                        <!--<li class="bank">
			                            <label for="psbc5">
			                        ...
			                        <li class="bank">
			                            <label for="boc5">
			                                ...
			                                --><img src="../s/img/banks/boc.gif-v=1591.gif"   width="100" height="20"  alt="中国银行" title="中国银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="cmb5">
			                                 <input type="radio" id="bankType" name="bankType" value="baofu_3001"/>
			                                <!--<input type="radio" id="bankType" name="bankType" value="ys_3085840"/>-->
			                                <img src="../s/img/banks/cmb.gif-v=1591.gif"   width="100" height="20"  alt="招商银行" title="招商银行"  />			                            </label>
			                        </li>
			                         
			                      	<li class="bank">
			                            <label for="spdb5">
			                                <input type="radio" id="bankType" name="bankType" value="lianlian_bank_03100000"/>
			                                <img src="../s/img/banks/spdb.gif-v=1591.gif"   width="100" height="20"  alt="浦发银行" title="浦发银行"  />			                            </label>
			                        </li>
						<li class="bank">
			                            <label for="citic5">
			                                <!--<input type="radio" id="bankType" name="bankType" value="ys_3021000"/>
			                                --><input type="radio" id="bankType" name="bankType" value="baofu_3039"/> 
			                                <img src="../s/img/banks/citic.gif-v=1591.gif"  width="100" height="20"  alt="中信银行" title="中信银行"  />			                            </label>
			                        </li>
			                         ...
			                         <li class="bank">
                            			...
                            			<!-- <input type="radio" id="bankType" name="bankType" value="lianlian_bank_03030000"/>-->
                                			...
                                			<img src="../s/img/banks/ceb.gif-v=1591.gif"   width="100" height="20"  alt="中国光大银行" title="中国光大银行"  />                            			</label>
                        			</li>
			                        ...
			                        <li class="bank">
			                            <label for="pab5">
			                                ...
			                                <img src="../s/img/banks/pab.gif-v=1591.gif"  width="100" height="20"  alt="平安银行" title="平安银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="cmbc5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3006"/>
			                                <!--<input type="radio" id="bankType" name="bankType" value="ys_3051000"/>
			                                --><img src="../s/img/banks/cmbc.gif-v=1591.gif"   width="100" height="20"  alt="中国民生银行" title="中国民生银行"  />			                            </label>
			                        </li>
			                           ...
			                           <li class="bank">
			                            <label for="cmbc5">
			                                ...
			                                <img src="../s/img/banks/bocom.gif-v=1591.gif"   width="100" height="20"  alt="中国交通银行" title="中国交通银行"  />			                            </label>
			                        </li>
			                           ...
			                           <li class="bank">
			                            <label for="cmbc5">
			                               ...
			                               <input type="radio" id="bankType" name="bankType" value="baofu_3009"/>
			                                <img src="../s/img/banks/cib.gif-v=1591.gif"   width="100" height="20"  alt="兴业银行" title="兴业银行"  />			                            </label>
			                        </li>
			                        
			                           <li class="bank">
			                            <label for="cmbc5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3050"/>
			                                <img src="../s/img/banks/hxbc.gif-v=1591.gif"   width="100" height="20"  alt="华夏银行" title="华夏银行"  />			                            </label>
			                        </li>
			                        ...
			                        <li class="bank">
			                            <label for="gdb5">
			                                ...
			                                <img src="../s/img/banks/gdb.gif-v=1591.gif"   width="100" height="20"  alt="广东发展银行" title="广东发展银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3038"/> 
			                                <img src="../s/img/banks/psbc.gif-v=1591.gif"  width="100" height="20"  alt="中国邮政银行" title="中国邮政银行"  />			                            </label>
			                        </li>
									
									<li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3037"/> 
			                                <img src="../s/img/banks/srcb.gif-v=1591.gif"   width="100" height="20"  alt="上海农商银行" title="上海农商银行"  />			                            </label>
			                        </li>
									<li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3060"/> 
			                                <img src="../s/img/banks/bjrcb.gif-v=1591.gif"  width="100" height="20"  alt="北京农商银行" title="北京农商银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3036"/> 
			                                <img src="../s/img/banks/czb.gif-v=1591.gif"   width="100" height="20"  alt="浙商银行" title="浙商银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3059"/> 
			                                <img src="../s/img/banks/bos.gif-v=1591.gif"   width="100" height="20"  alt="上海银行" title="上海银行"  />			                            </label>
			                        </li>
			                      
			                         <li class="bank">
			                            <label for="psbc5">
			                                <input type="radio" id="bankType"  name="bankType" value="baofu_11" checked="checked"/>
			                                <img src="../s/img/banks/baofoo.gif-v=1591.gif"   width="100" height="20"  alt="宝付" title="宝付"  />			                            </label>
			                        </li>
			                      ...
			                      <!--	<li class="bank">
                              		...
                              		<li class="bank">
			                            <label for="lianlian">
			                                ...
			                                <img src="../s/img/banks/lianlian.gif-v=1591.gif"   width="100" height="20"  alt="连连支付" title="连连支付"  />			                            </label>
			                        </li>
									<!--<li class="bank">
			                            <label for="yizhifu">
...
<input type="hidden" value="<%=basePath%>" id="juedui">
