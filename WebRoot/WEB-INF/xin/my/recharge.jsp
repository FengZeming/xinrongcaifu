...
<div class="hmenu_nav">
  <div class="main PositionR">
    <div class="logo left PositionR"><a href="../index.shtml.htm" tppabs="https://xin/index.shtml"><img src="../2.0/images/logo.gif" tppabs="https://xin/2.0/images/logo.gif" /></a><a href="../2.0/views/about/shareholder.shtml.htm" tppabs="https://xin/2.0/views/about/shareholder.shtml" class="logo_font">上市公司系</a></div>
    <div class="right top_my"><a href="../2.0/views/account/account_index.shtml.htm" tppabs="https://xin/2.0/views/account/account_index.shtml" class="f-my" id="nav_my">我的账户</a> <a id="j-logout" href="../index.shtml.htm" tppabs="https://xin/logout" class="f_exit" style="display:none;">退出</a><span class="h-login-reg h-login"><i></i><a href="../2.0/login2.0.html" tppabs="https://xin/2.0/login2.0.html" class="flogin">登录</a><a href="../2.0/views/account/register4.0.shtml.htm" tppabs="https://xin/2.0/views/account/register4.0.shtml" class="freg">注册</a></span></div>
    <div class="clear"></div>
  </div>
  <div class="h_nav" id="hmenu_nav">
    <div class="main PositionR">
      <ul>
        ...
        <li><a href="../2.0/action/zt_call/xr_call.shtml.htm" tppabs="https://xin/2.0/action/zt_call/xr_call.shtml" id="nav_duoduo">朵朵来电</a></li>
        <li><a href="../2.0/views/about/invest_help.shtml.htm" tppabs="https://xin/2.0/views/about/invest_help.shtml" id="nav_invest_help">新手指引<i class="arrow"></i></a>
          <ul>
            ...
            <li><a href="../2.0/views/about/help.shtml.htm" tppabs="https://xin/2.0/views/about/help.shtml" id="nav_help" target="_blank">问题答疑</a></li>
          </ul>
        </li>
        <li><a href="../2.0/views/about/about.shtml.htm" tppabs="https://xin/2.0/views/about/about.shtml">信息披露<i class="arrow"></i></a>
          <ul>
            ...
            <li><a href="../2.0/views/about/xr_announcement.shtml.htm" tppabs="https://xin/2.0/views/about/xr_announcement.shtml">平台公告</a></li>
            <li><a href="../2.0/views/about/partner.shtml.htm" tppabs="https://xin/2.0/views/about/partner.shtml">合作机构</a></li>
            <li><a href="../2.0/views/about/contact.shtml.htm" tppabs="https://xin/2.0/views/about/contact.shtml">联系我们</a></li>
          </ul>
        </li>
      </ul>
      <div class="nav_r"><a href="../2.0/vip.html" tppabs="https://xin/2.0/vip.html" id="nav_vip">VIP特权</a> | <a href="../gift.htm" tppabs="https://xin/gift" id="nav_gift">积品汇</a></div>
    </div>
  </div>
</div>
...
<div class="side-nav g-well g-left">
    ...
    <h3 style="position:relative;"><a href="../2.0/views/account/esw_account.html" tppabs="https://xin/2.0/views/account/esw_account.html" class="item esw">存管账户</a><span class="esw_new"><img src="../2.0/images/esw_new.png" tppabs="https://xin/2.0/images/esw_new.png" width="44" height="45" /></span></h3>
    <h3><a id="side-nav-xcb" class="item xcb" href="../2.0/xincunbao.shtml.htm" tppabs="https://xin/2.0/xincunbao.shtml">信 存 宝<i>R</i></a></h3>
    <h3><a id="side-nav-invest" class="item" href="invest.htm" tppabs="https://xin/my/invest">投资管理</a></h3>
    ...
    <h3 style="display:none"><a id="side-nav-cash" class="item current" href="recharge.htm" tppabs="https://xin/my/recharge">充值提现</a></h3>
    <h3><a id="side-nav-consume" class="item" href="consume.htm" tppabs="https://xin/my/consume">收支查询</a></h3>
    <h3><a id="side-nav-invite"  class="item invite" href="../2.0/recommend.html" tppabs="https://xin/2.0/recommend.html">推荐有奖</a></h3>
    <h3><a id="side-nav-zz" class="item service" href="../2.0/my_service.html" tppabs="https://xin/2.0/my_service.html">增值服务</a></h3>
    <h3><a id="side-nav-dd" class="item duoduo" href="../2.0/views/call/call.shtml.htm" tppabs="https://xin/2.0/views/call/call.shtml">朵朵来电<!--<b class="AllIcon iconnew"></b>--></a></h3>
    ...
    <h3><a href="recharge.htm" tppabs="https://xin/my/recharge" class="recharge current">充值</a></h3>
    <h3><a href="deposit.htm" class="last deposit">提现</a></h3>
</div>            <style>
.t-hover{ vertical-align: middle; position: relative; display: inline-block; padding-left:10px;}
.t-hover i{display:none}
.t-hover:hover i{display: block; position: absolute; right: -125px; top: 0; cursor: pointer;}
</style>

<div class="form-container recharge-form">
<p class="ui-tip-warn" id="recharge_no_loan_alert" style=" display:none;">
  ...
  <script type="text/javascript" src="./myjs/recharge.js"></script>
            ...
            <div class="ui-form-line money" style="height:auto">
              ...
              <!--   <div class="rechargefont"><dl><dt>选择方式：</dt><dd><ul><li class="hoverbg bor"><a href="recharge.htm" tppabs="https://xin/my/recharge">有网银大额支付</a></li><li><a href="rechargec.htm" tppabs="https://xin/my/rechargec">无网银快捷支付</a></li></ul></dd></dl><div style="clear:both"></div></div>
                 -->
                ...
                <input type="text" name="money" id="money" class="ui-form-input" maxlength="10" autocomplete="off" value=""/> 元
                <input type="text" class="fix-ie6 g-hide"/>
                <em class="ui-tip" style="margin-left:5px;"></em>
                <div class="ui-form-line ui-form-action">
                <input class="ui-button ui-button-orange"  type="submit"  id="queren" value="确定充值" />
                <!--
                
                <span>财付通故障暂停充值</span>
                -->
                <span style="color: gray;font-size: 14px;" >关注信融服务号 资金动态一手掌握<span class="t-hover"><img src="../2.0/images/t-j04.png" tppabs="https://xin/2.0/images/t-j04.png" id="showRechargeXrWeixin" /><i><img src="../s/img/w02.jpg" tppabs="https://xin/s/img/w02.jpg" width="120" /></i></span></span>
                <em class="ui-tip" style="margin-left:20px;"></em>
                </div>
				<p class="ui-tip info">为了您的资金安全，请尽快开通财付通账号并实名认证。<br />充值后未投资的资金提现将收取额外0.5%手续费。<a href="../2.0/views/about/help.shtml-tab=tab2&href=b6.htm" tppabs="https://xin/2.0/views/about/help.shtml?tab=tab2&href=b6" target="_blank" class="blue">详情</a></p>
				<input type="hidden" id="lowest_pay" value="10"/>
            </div>
            
            <div class="ui-form-line banks">
                
                <div class="banks-panel">
                    			
                   			                    			 
                   			 <input id="pay_type" type="hidden" name="pay_type" value="6"/>
                   			 
                   			  <ul class="g-fix">
								<li class="bank">
			                   <label for="psbc5">
			                      <input type="radio" id="bankType" name="bankType" value="baofu_3005"/>
			                       <!--<input type="radio" id="bankType" name="bankType" value="ys_1031000"/>
			                         --><img src="../s/img/banks/abc.gif-v=1591.gif" tppabs="https://xin/s/img/banks/abc.gif?v=1591"  width="100" height="20"  alt="中国农业银行" title="中国农业银行"  />			                            </label>
			                        </li>
                    
			                       <li class="bank">
			                            <label for="icbc5">
			                            <input type="radio"  id="bankType" name="bankType" value="baofu_3002"/>
			                         <!--<input type="radio" id="bankType" name="bankType" value="ys_1021000"/>  -->      
			                         <img src="../s/img/banks/icbc.gif-v=1591.gif" tppabs="https://xin/s/img/banks/icbc.gif?v=1591"  width="100" height="20"  alt="中国工商银行" title="中国工商银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="ccb5">
			                             <input type="radio" id="bankType" name="bankType" value="baofu_3003"/> 
			                          <!--<input type="radio" id="bankType" name="bankType" value="ys_1051000"/>-->
			                            <img src="../s/img/banks/ccb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/ccb.gif?v=1591"  width="100" height="20"  alt="中国建设银行" title="中国建设银行"  />			                            </label>
			                        </li>
			                        <!--<li class="bank">
			                            <label for="psbc5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3038"/>
			                                <img src="https://xin/s/img/banks/psbc.gif?v=1591"  width="100" height="20"  alt="中国邮政储蓄银行" title="中国邮政储蓄银行"  />			                            </label>
			                        </li>-->
			                        <li class="bank">
			                            <label for="boc5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3026"/>
			                                <!--
			                                <input type="radio" id="bankType" name="bankType" value="ys_1041000"/>
			                                --><img src="../s/img/banks/boc.gif-v=1591.gif" tppabs="https://xin/s/img/banks/boc.gif?v=1591"  width="100" height="20"  alt="中国银行" title="中国银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="cmb5">
			                                 <input type="radio" id="bankType" name="bankType" value="baofu_3001"/>
			                                <!--<input type="radio" id="bankType" name="bankType" value="ys_3085840"/>-->
			                                <img src="../s/img/banks/cmb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/cmb.gif?v=1591"  width="100" height="20"  alt="招商银行" title="招商银行"  />			                            </label>
			                        </li>
			                         
			                      	<li class="bank">
			                            <label for="spdb5">
			                                <input type="radio" id="bankType" name="bankType" value="lianlian_bank_03100000"/>
			                                <img src="../s/img/banks/spdb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/spdb.gif?v=1591"  width="100" height="20"  alt="浦发银行" title="浦发银行"  />			                            </label>
			                        </li>
						<li class="bank">
			                            <label for="citic5">
			                                <!--<input type="radio" id="bankType" name="bankType" value="ys_3021000"/>
			                                --><input type="radio" id="bankType" name="bankType" value="baofu_3039"/> 
			                                <img src="../s/img/banks/citic.gif-v=1591.gif" tppabs="https://xin/s/img/banks/citic.gif?v=1591"  width="100" height="20"  alt="中信银行" title="中信银行"  />			                            </label>
			                        </li>
			                        
			                         <li class="bank">
                            			<label for="ceb2">
                            			<!-- <input type="radio" id="bankType" name="bankType" value="lianlian_bank_03030000"/>-->
                               		 	<input type="radio" id="bankType"  name="bankType" value="baofu_3022" />
                                			<img src="../s/img/banks/ceb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/ceb.gif?v=1591"  width="100" height="20"  alt="中国光大银行" title="中国光大银行"  />                            			</label>
                        			</li>
                        			
			                        
			                        <li class="bank">
			                            <label for="pab5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3035"/>
			                                <img src="../s/img/banks/pab.gif-v=1591.gif" tppabs="https://xin/s/img/banks/pab.gif?v=1591"  width="100" height="20"  alt="平安银行" title="平安银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="cmbc5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3006"/>
			                                <!--<input type="radio" id="bankType" name="bankType" value="ys_3051000"/>
			                                --><img src="../s/img/banks/cmbc.gif-v=1591.gif" tppabs="https://xin/s/img/banks/cmbc.gif?v=1591"  width="100" height="20"  alt="中国民生银行" title="中国民生银行"  />			                            </label>
			                        </li>
			                        
			                        
			                           <li class="bank">
			                            <label for="cmbc5">
			                            	<!--<input type="radio" id="bankType" name="bankType" value="ys_3012900"/>
			                            	<input type="radio" id="bankType" name="bankType" value="baofu_3020"/>-->
			                            	<input type="radio" id="bankType" name="bankType" value="lianlian_bank_03010000"/>
			                                <img src="../s/img/banks/bocom.gif-v=1591.gif" tppabs="https://xin/s/img/banks/bocom.gif?v=1591"  width="100" height="20"  alt="中国交通银行" title="中国交通银行"  />			                            </label>
			                        </li>
			                        
			                           <li class="bank">
			                            <label for="cmbc5">
			                            	 <!--<input type="radio" id="bankType" name="bankType" value="ys_3093910"/>-->
			                               <input type="radio" id="bankType" name="bankType" value="baofu_3009"/>
			                                <img src="../s/img/banks/cib.gif-v=1591.gif" tppabs="https://xin/s/img/banks/cib.gif?v=1591"  width="100" height="20"  alt="兴业银行" title="兴业银行"  />			                            </label>
			                        </li>
			                        
			                           <li class="bank">
			                            <label for="cmbc5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3050"/>
			                                <img src="../s/img/banks/hxbc.gif-v=1591.gif" tppabs="https://xin/s/img/banks/hxbc.gif?v=1591"  width="100" height="20"  alt="华夏银行" title="华夏银行"  />			                            </label>
			                        </li>
									...
									<li class="bank">
			                            <label for="bea2">
			                                <input type="radio" id="bankType"  name="bankType" value="BEA_D_B2C">
			                                <img src="https://xin/s/img/banks/bea.gif?v=1591"  width="100" height="20"  alt="东亚银行" title="东亚银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="njcb2">
			                                <input type="radio" id="bankType"  name="bankType" value="BON_D_B2C">
			                                <img src="https://xin/s/img/banks/njcb.gif?v=1591"  width="100" height="20"  alt="南京银行" title="南京银行"  />			                            </label>
			                        </li>
									...
									<li class="bank">
			                            <label for="beifu">
			                                <input type="radio" id="bankType"   name="bankType" value="beifu">
			                                <img src="https://xin/s/img/banks/beifu.gif?v=1591"  width="100" height="20"  alt="贝付" title="贝付"  />			                            </label>
			                        </li>
			                       
			                         
                       				  <li class="bank">
			                            <label for="psbc5">
			                                <input type="radio" id="bankType" name="bankType" value="ys_3133010"/>
			                                <img src="https://xin/s/img/banks/njb.gif?v=1591"  width="100" height="20"  alt="南京银行" title="南京银行"  />			                            </label>
                       				  ...
                       				  <li class="bank">
			                            <label for="psbc5">
			                                <input type="radio" id="bankType" name="bankType" value="ys_5021000"/>
			                                <img src="https://xin/s/img/banks/bea.gif?v=1591"  width="100" height="20"  alt="东亚银行" title="东亚银行"  />			                            </label>
			                        </li>
			                        -->
			                        <li class="bank">
			                            <label for="gdb5">
			                            	<!--  <input type="radio" id="bankType" name="bankType" value="ys_3065810"/>-->
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3036"/> 
			                                <img src="../s/img/banks/gdb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/gdb.gif?v=1591"  width="100" height="20"  alt="广东发展银行" title="广东发展银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3038"/> 
			                                <img src="../s/img/banks/psbc.gif-v=1591.gif" tppabs="https://xin/s/img/banks/psbc.gif?v=1591"  width="100" height="20"  alt="中国邮政银行" title="中国邮政银行"  />			                            </label>
			                        </li>
									
									<li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3037"/> 
			                                <img src="../s/img/banks/srcb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/srcb.gif?v=1591"  width="100" height="20"  alt="上海农商银行" title="上海农商银行"  />			                            </label>
			                        </li>
									<li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3060"/> 
			                                <img src="../s/img/banks/bjrcb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/bjrcb.gif?v=1591"  width="100" height="20"  alt="北京农商银行" title="北京农商银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3036"/> 
			                                <img src="../s/img/banks/czb.gif-v=1591.gif" tppabs="https://xin/s/img/banks/czb.gif?v=1591"  width="100" height="20"  alt="浙商银行" title="浙商银行"  />			                            </label>
			                        </li>
			                        <li class="bank">
			                            <label for="gdb5">
			                                <input type="radio" id="bankType" name="bankType" value="baofu_3059"/> 
			                                <img src="../s/img/banks/bos.gif-v=1591.gif" tppabs="https://xin/s/img/banks/bos.gif?v=1591"  width="100" height="20"  alt="上海银行" title="上海银行"  />			                            </label>
			                        </li>
			                      
			                         <li class="bank">
			                            <label for="psbc5">
			                                <input type="radio" id="bankType"  name="bankType" value="baofu_11" checked="checked"/>
			                                <img src="../s/img/banks/baofoo.gif-v=1591.gif" tppabs="https://xin/s/img/banks/baofoo.gif?v=1591"  width="100" height="20"  alt="宝付" title="宝付"  />			                            </label>
			                        </li>
			                        
			                      <!--	<li class="bank">
			                            <label for="tenpay">
			                                <input type="radio" id="bankType"    name="bankType" value="DEFAULT"  />
			                                <img src="https://xin/s/img/banks/tdf.gif?v=1591"  width="100" height="20"  alt="财付通" title="财付通"  />			                            </label>
			                        </li>-->
                              		<li class="bank">
			                            <label for="lianlian">
			                                <input type="radio" id="bankType"    name="bankType" value="lianlian_bank"/>
			                                <img src="../s/img/banks/lianlian.gif-v=1591.gif" tppabs="https://xin/s/img/banks/lianlian.gif?v=1591"  width="100" height="20"  alt="连连支付" title="连连支付"  />			                            </label>
			                        </li>
									<!--<li class="bank">
			                            <label for="yizhifu">
			                                <input type="radio" id="bankType"  name="bankType" value="yizhifu" >
			                                <img src="https://xin/s/img/banks/yizhifu.png?v=1591"  width="100" height="20"  alt="翼支付" title="翼支付"  />			                            </label>
			                        </li>  -->
			                         
			                        
			                        <!-- <li class="bank">
			                            <label for="psbc5">
			                                <input type="radio" id="bankType" name="bankType" value="ys_11" />
			                                <img src="https://xin/s/img/banks/yinsheng.jpg?v=1591"  width="100" height="20"  alt="银盛" title="银盛"  />			                            </label>
			                        </li>-->
...
$('.banks-panel input[value=""]').attr('checked', true);
...
<li><h2>产品体系</h2><p><a href="../2.0/vip.html" tppabs="https://xin/2.0/vip.html" target="_blank">VIP特权</a></p><p><a href="../gift.htm" tppabs="https://xin/gift" target="_blank">积品汇</a></p><p><a href="../action/jf.htm" tppabs="https://xin/action/jf" target="_blank">抽奖</a></p></li>
</ul>
</div>
