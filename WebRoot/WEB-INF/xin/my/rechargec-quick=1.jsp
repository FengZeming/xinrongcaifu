    ...
    <fieldset class="ui-form">
            ...
            <div class="ui-form-line money" style="height:auto">
               ...
               <br/>
                ...
                <p class="ui-tip info">充值后未投资的资金提现将收取额外0.5%手续费。<a href="../2.0/views/about/help.shtml-tab=tab2&href=b6.htm" tppabs="https://xin/2.0/views/about/help.shtml?tab=tab2&href=b6" target="_blank" class="blue">详情</a></p>
				</div>
				...
				<label class="ui-form-label">认证账户：</label>
					...
					请先进行<a class="blue" href="../2.0/views/account/account_settings.shtml.htm" tppabs="https://xin/2.0/views/account/account_settings.shtml">银行卡认证</a>
